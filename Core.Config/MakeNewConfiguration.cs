...
namespace Core.Config
{
    ...
    public static class MakeNewConfiguration
    {
        ...
        /// <see cref="T:Core.Config.IConfiguration" /> interface and returns a reference
        /// to it.
        /// </summary>
        /// <returns>
        ...
        /// <see
        ///     cref="P:Core.Config.IConfiguration" />
        /// property.
        /// </summary>
        /// <param name="self">
        ...
        /// the
        /// <see
        ///     cref="T:Core.Config.IConfiguration" />
        /// interface.
        /// </param>
        /// <param name="value">
        /// (Required.) The new value for the
        /// <see cref="P:Core.Config.IConfiguration.CreateDataAccessLayer" /> property.
        /// </param>
        /// <returns>
        ...
        /// <param name="value">
        /// (Required.) The new value for the
        /// <see cref="P:Core.Config.IConfiguration.CreateUserInterfaceLayer" /> property.
        /// </param>
        /// <returns>
        /// Reference to the same instance of the object that called this
        /// method, for fluent use.
