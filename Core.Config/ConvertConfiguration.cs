...
namespace Core.Config
{
    ...
    public static class ConvertConfiguration
    {
        ...
        /// <see cref="T:Newtonsoft.Json.JsonSerializerSettings" /> whose values govern the
        /// format of the JSON.
        /// </summary>
        ...
        /// <summary>
        /// Converts a string containing JSON to an instance, in memory, of an
        /// object that implements the <see cref="T:Core.Config.IConfiguration" />
        /// interface and returns a reference to the newly-initialized object.
        /// </summary>
