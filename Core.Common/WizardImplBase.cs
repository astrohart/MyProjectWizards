...
namespace Core.Common
{
    ...
    /// <see cref="T:Microsoft.VisualStudio.TemplateWizard.IWizard" /> interface share
    /// in common.
    /// </summary>
    public abstract class WizardImplBase
    {
        ...
        /// <see cref="F:Core.Common.WizardImplBase._dte" /> field using the value of the
        /// <paramref name="automationObject" /> parameter.  Overrides should call the base
        ...
        */
        ...
        /// <see cref="T:Core.Common.DebugLevel.Debug" /> value for the 'level' parameter
        /// in the other overload of this method.
        /// </summary>
        /// <param name="text">
        /// (Required.) String containing the text to be sent to the log
        /// file.
        /// </param>
        ...
        /// <summary>
        /// Given a <see cref="T:Core.Common.DebugLevel" /> value specified in the
        /// <paramref name="level" /> parameter, generates a string with a label for the
        /// category of message that corresponds to it.
        /// </summary>
        /// <param name="level">
        /// (Required.) A <see cref="T:Core.Common.DebugLevel" /> value
        /// that specifies the category of logging message.
        /// </param>
        /// <returns>
        /// String containing the label that corresponds to the category of
        /// logging message identified by the <paramref name="level" /> parameter's value.
        /// </returns>
        /// <remarks>
        /// If a <see cref="T:Core.Common.DebugLevel" /> value is passed for which there is
        ...
        /// <summary>
        /// Writes the specified line of <paramref name="text" /> to the log, and
        /// categorizes it by <see cref="T:Core.Common.DebugLevel" />.
        /// </summary>
        /// <param name="level">
        /// (Required.) A <see cref="T:Core.Common.DebugLevel" /> value
        ...
        /// </param>
        /// <remarks>
        /// If the <paramref name="text" /> parameter is passed a blank or
        /// <see langword="null" /> string, then this method does nothing.
        /// </remarks>
        ...
        /// <summary>
        /// Dumps detailed information about the specified <paramref name="exception" /> to
        /// the log file.
        /// </summary>
        /// <param name="exception">
        /// (Required.) Reference to a
        /// <see cref="T:System.Exception" /> that describes the error that has occurred.
        /// </param>
        /// <remarks>
        /// If <see langword="null" /> is passed for the
        /// <paramref name="exception" /> parameter, then this method does nothing.
        /// </remarks>
        ...
        /// <see cref="P:Core.Common.WizardImplBase.CurrentConfiguration" /> property to
        /// point to it.
        /// </summary>
