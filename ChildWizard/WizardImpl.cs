...
{
    /// <summary>
    /// Implements a wizard for the generation of an individual project in
    /// the solution.
    /// </summary>
    public class WizardImpl : WizardImplBase, IWizard
    {
        /// <summary>
        /// Contains the name of the folder that was erroneously generated in
        /// order to contain the generated sub-projects, which we assume has the same name
        /// as the solution (without the <c>.sln</c> file extension, so we are giving it a
        /// descriptive name as such.
        /// </summary>
        private string _containingSolutionName;

        /// <summary>
        /// String containing the fully-qualified pathname of the sub-folder in
        /// which this particular project (this Wizard is called once for each sub-project
        /// in a multi-project template) is going to live in.
        /// </summary>
        private string _generatedSubProjectFolder;

        /// <summary> String containing the name of the project that is safe to use. </summary>
        ...
        /// The automation object being used by the
        /// template wizard.
        /// </param>
        ...
        {
            base.RunStarted(
                automationObject, replacementsDictionary, runKind, customParams
            );
