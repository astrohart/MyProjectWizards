...
namespace ChildWizard
{
    ...
    public partial class ExampleDialogBox : Form
    {
        ...
        /// <see cref="T:ChildWizard.ExampleDialogBox" /> and returns a reference to it.
        /// </summary>
        /// <param name="dte">
        ...
        /// Thrown if the required
        /// parameters, <paramref name="destinationDirectory" /> or
        /// <paramref name="safeProjectName" /> , are passed a blank or
