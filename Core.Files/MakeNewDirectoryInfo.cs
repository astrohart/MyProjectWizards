...
namespace Core.Files
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of <see cref="T:System.IO.DirectoryInfo" />
        /// initialized with the directory whose fully-qualified pathname is passed in the
        /// <paramref name="path" /> parameter.
        /// </summary>
        /// <param name="path">
        /// (Required.) String containing the fully-qualified pathname for which an
        /// instance of <see cref="T:System.IO.DirectoryInfo" /> should be manufactured.
        /// </param>
        /// <returns>
        ...
        /// Thrown if the directory whose path is specified in the <paramref name="path" />
